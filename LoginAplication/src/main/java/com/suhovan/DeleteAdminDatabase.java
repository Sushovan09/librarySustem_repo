...
@WebServlet("/deleteA2")
public class DeleteAdminDatabase extends HttpServlet{
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException,IOException {
		...
		try {
			...
			String query = String.format("DELETE FROM admin_table WHERE AUserName = '%s' AND APassword = '%s'",username,passwd);
